...
function Log(props: LogProps) {
    return (
        <div className="flex rounded-xl bg-darkocean p-4 gap-2 justify-around hover:bg-slate-800 w-full">
            <img src="https://i.pinimg.com/236x/d0/05/0d/d0050d5c9f600d1cb362404d576aa199.jpg" className="w-12 object-cover rounded-xl"/>
            <div className='flex flex-col w-10/12'>
                <div className="flex w-10/12 justify-between">
                    <span className="font-medium text-md">Gumiya</span>
