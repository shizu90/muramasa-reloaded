function Login() {
    return (
        <main className="w-full flex justify-center items-center">
            <form className="flex flex-col gap-4 bg-[#151F2E] p-8 justify-center items-center text-slate-50">
                ...
                <a href="#" className="text-sm text-slate-400 py-2 hover:underline transition-all cursor-pointer">Forgot password?</a>
                <span className="text-sm text-slate-400 py-8">Don't have an account? <a href="#" className="text-rose-500 hover:underline cursor-pointer">Create here</a></span>
            </form>
        </main>
    )
}
